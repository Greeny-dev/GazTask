...
async def update_meterings(manager: UpdaterInterface = Depends(dependency.dm.get_update_manager)):
...
async def update_states(manager: UpdaterInterface = Depends(dependency.dm.get_update_manager)):
